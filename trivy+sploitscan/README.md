...
Для настройки можно запустить скрипт и внести значения в интерактивном режиме:  
```bash
python setup_config.py
```

Или же указать параметры, соответствующие вашей системе, напрямую в config.json:
```json
{
